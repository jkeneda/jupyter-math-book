...
function randomMonic () {
    ...
    document.getElementById('monic-div').innerHTML = 'Factor <math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup>
    <mo>' + sign2pm(m + n) + '</mo><mn>' + Math.abs(m + n) + '</mn><mi>x</mi><mo>' + sign2pm(m*n) + '</mo><mn>' + Math.abs(m*n) + '</mn></math>';
