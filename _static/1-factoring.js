...
function randomizeExample () {
    ...
    document.getElementById('outer-test-box').innerHTML = 'Factor <math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup><mo>' + Math.sign(m + n) + '</mo><mn>' + Math.abs(m + n) + '</mn><mi>x</mi><mo>' + Math.sign(m*n) + '</mo><mn>' + Math.abs(m*n) + '</mn></math>';
